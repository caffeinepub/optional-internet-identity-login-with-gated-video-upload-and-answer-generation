...
import type { Answer as _Answer, AudioClue as _AudioClue, ExternalBlob as _ExternalBlob, ImageClue as _ImageClue, UserProfile as _UserProfile, UserRole as _UserRole, VideoClue as _VideoClue, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async generateAnswer(arg0: Array<bigint>, arg1: string | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateAnswer(arg0, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAnswer(arg0: bigint): Promise<Answer | null> {
        if (this.processError) {
            try {
    ...
    async getAudioClue(arg0: bigint): Promise<AudioClue | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAudioClue(arg0);
    ...
    async getImageClue(arg0: bigint): Promise<ImageClue | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageClue(arg0);
    ...
    async getVideoClue(arg0: bigint): Promise<VideoClue | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoClue(arg0);
    ...
    async uploadAudioClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadAudioClue(await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImageClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImageClue(await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideoClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideoClue(await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AudioClue_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AudioClue): Promise<AudioClue> {
...
async function from_candid_ImageClue_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageClue): Promise<ImageClue> {
...
async function from_candid_VideoClue_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoClue): Promise<VideoClue> {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Answer]): Answer | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AudioClue]): Promise<AudioClue | null> {
    return value.length === 0 ? null : await from_candid_AudioClue_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ImageClue]): Promise<ImageClue | null> {
    return value.length === 0 ? null : await from_candid_ImageClue_n20(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VideoClue]): Promise<VideoClue | null> {
    return value.length === 0 ? null : await from_candid_VideoClue_n23(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        owner: value.owner,
        audioBlob: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.audioBlob),
