...
export class Backend implements backendInterface {
    ...
    async generateAnswer(arg0: Array<bigint>, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateAnswer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadAudioClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadAudioClue(await to_candid_ExternalBlob_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImageClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImageClue(await to_candid_ExternalBlob_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideoClue(arg0: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideoClue(await to_candid_ExternalBlob_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AudioClue_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AudioClue): Promise<AudioClue> {
...
async function from_candid_ImageClue_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageClue): Promise<ImageClue> {
...
async function from_candid_VideoClue_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoClue): Promise<VideoClue> {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Answer]): Answer | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AudioClue]): Promise<AudioClue | null> {
    return value.length === 0 ? null : await from_candid_AudioClue_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ImageClue]): Promise<ImageClue | null> {
    return value.length === 0 ? null : await from_candid_ImageClue_n19(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VideoClue]): Promise<VideoClue | null> {
    return value.length === 0 ? null : await from_candid_VideoClue_n22(_uploadFile, _downloadFile, value[0]);
}
